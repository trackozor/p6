 ...
 * 
 * Étapes principales :
 * 1. Ajoute la classe CSS pour afficher la modale.
 * 2. Désactive le défilement de la page en arrière-plan.
 * 3. Met à jour l'état global de la modale (`modalOpen`).
 * 4. Journalise chaque étape pour le suivi.
 * 
 * @returns {void}
 */
export function launchModal() {
    try {
        ...
        // Étape 1 : Ajoute la classe pour afficher la modale
        ...
        // Étape 3 : Met à jour l'état global
        modalOpen = true;
